...
public class yasiBookView extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					yasiBookView frame = new yasiBookView();
	 ...
	 */
	public yasiBookView() {
		setFrameIcon(new ImageIcon(yasiBookView.class.getResource("/images/\u96C5\u601D\u57F9\u8BAD\u7F34\u8D39 (1).png")));
		setIconifiable(true);
		setMaximizable(true);
		setClosable(true);
		setTitle("\u96C5\u601D\u4E66\u7C4D\u4E00\u89C8");
		...
		JLabel lblNewLabel = new JLabel("\u9009\u62E9\u8981\u8FDB\u884C\u542C\u5199\u7684\u8BCD\u6C47\u4E66\u7C4D\uFF1A");
