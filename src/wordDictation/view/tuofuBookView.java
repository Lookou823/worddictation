...
public class tuofuBookView extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					tuofuBookView frame = new tuofuBookView();
	 ...
	 * Create the frame.
	 */
	public tuofuBookView() {
		setFrameIcon(new ImageIcon(tuofuBookView.class.getResource("/images/\u96C5\u601D\u57F9\u8BAD\u7F34\u8D39 (1).png")));
		setIconifiable(true);
		setMaximizable(true);
		setClosable(true);
		setTitle("\u96C5\u601D\u4E66\u7C4D\u4E00\u89C8");
